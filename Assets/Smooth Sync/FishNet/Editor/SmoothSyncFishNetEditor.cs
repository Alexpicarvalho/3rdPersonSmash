...
namespace Smooth
{
    [CustomEditor(typeof(SmoothSyncFishNet))]
    public class SmoothSyncFishNetEditor : Editor
    {
        ...
        {
            SmoothSyncFishNet myTarget = (SmoothSyncFishNet)target;
            ...
            if (showExtrapolation)
            {
                ...
                if (myTarget.extrapolationMode == SmoothSyncFishNet.ExtrapolationMode.Limited)
                {
